...
public class InstagramActivity extends AppCompatActivity {
    ...
    private InstagramAdapter mAdaper = new InstagramAdapter(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(dataSet.equalsIgnoreCase("")){
            ...
            Type type = new TypeToken<List<InstagItem>>(){}.getType();
            listInstag = gson.fromJson(dataSet,type);
            mAdaper.swapDataSet(listInstag);
        }
    ...
    protected void onStop() {
        //saving current data.
        Gson gson = new Gson();
        String json = gson.toJson(mAdaper.getDataSet());
